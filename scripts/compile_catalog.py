...
def build_artifacts(
    ...
    dependency_template = "\n".join(
        [
            ...
            "{%- endfor -%}",
            "{%- endfor %}",
            "{%- if ai_capabilities != 'none' or sql_store != 'none' or document_store != 'none' or vector_store != 'none' or graph_store != 'none' or cache_store != 'none' or auth | default('none', true) != 'none' %}",
            '    "pydantic>=2.13.4,<3",',
